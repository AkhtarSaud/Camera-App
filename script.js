...
showGallery.addEventListener("click", function (e) {
    ...
    modal.innerHTML = `<div class="title">
                        ...
                        <span class="close-modal" style="float: right; margin-top: 10px; margin-right: 20px; cursor: pointer;"><img src="https://img.icons8.com/fluent/28/000000/cancel.png"/></span>
                    </div>
                    <div class="gallery">
                    </div>`;
